...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: Location validation query failed", cursor, testValues);
    ...
    public void testWeatherTable() {
        ...
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: Weather validation query failed", cursor, testValues);
